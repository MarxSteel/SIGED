  ...
  <div class="content-wrapper">
   <div class="container">
    ...
    <section class="content">
     ...
     <div class="col-xs-12"> 
      ...
      <div class="col-xs-12">
        ...
        <table width="400" border="0" align="center">
         <tr>
          <div class="col-xs-12"><br />
            <input name="enviar" type="submit" class="btn btn-danger btn-lg btn-block" id="enviar" value="DESATIVAR CLUB"  />
          </div>
         </tr>
        </table>
       </form>
       <?php 
        if(@$_POST["enviar"]){
          $executa = $PDO->query("UPDATE icbr_clube SET icbr_Status='D' WHERE icbr_id='$CodClub' ");
             if($executa)
               {
          ...
          echo '<script type="text/javascript">alert("Erro ao desativar club, entre em contato com a Interact Brasil");</script>';
          }
      }
      ?>
    ...
    <?php
      ...
      echo '<h2 class="box-title">DESATIVAR CLUB</h2>';
      echo '</div>';
